...
void setup() {
  ...
  display.println(F("IP: 10.0.1.23"));
  display.println(F("Sending val #0"));
  //display.print(F("Temperature: ")); display.print("22"); display.println(F(" degrees C"));
...
void loop() {
  ...
  */
  ...
  Serial.print(F("Temperature: ")); Serial.print(temp.temperature); Serial.println(F(" degrees C"));
  Serial.print(F("Humidity: ")); Serial.print(humidity.relative_humidity); Serial.println(F("% rH"));
  Serial.print(F("Read duration (ms): ")); Serial.println(timestamp);
  delay(10);
